...
const DetachedWindow = require('./main-detachedNote')
...
ipc.on('open-detached-note', function (event, locationQuery) {
  console.log('opening note in a detached window…')
  var detachedWindow = new DetachedWindow(locationQuery.key)
  detachedWindow.show()
  detachedNoteWindows.push(detachedWindow)
